const Logo = () => {
  return (
    <svg id="레이어_1" data-name="레이어 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150.66 26.7">
      <path className="cls-1" style={{ fill: "#2b61e1" }} d="M.62,1.88a1,1,0,0,1,.3-.71A.87.87,0,0,1,1.6.9H20a1.05,1.05,0,0,1,.71.27,1.05,1.05,0,0,1,.27.71V5.22a.9.9,0,0,1-.27.69,1.09,1.09,0,0,1-.71.26H14.12V24.91a1,1,0,0,1-.3.71,1.05,1.05,0,0,1-.71.27H8.79a.88.88,0,0,1-.68-.27,1,1,0,0,1-.27-.71V6.17H1.6a.9.9,0,0,1-.68-.26.83.83,0,0,1-.3-.69Z"/>
